...
tf.flags.DEFINE_string("Democrat_data_file", "./../Datasets/trainvaltest/demfulltrain4.txt", "Data source for Democrat data")
tf.flags.DEFINE_string("Republican_data_file", "./../Datasets/trainvaltest/repfulltrain4.txt", "Data source for Republican data.")
...
x_vtext, y_val = data_helpers2.load_data_and_labels('./../Datasets/trainvaltest/demfullval4.txt', './../Datasets/trainvaltest/repfullval4.txt')
...
printerr('predictvall.txt', predictions, y_val, x_vtext)
printerr('predicttestl.txt', predictionst, y_test, x_ttext)
